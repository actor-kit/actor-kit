/* eslint-disable */
// Generated by Wrangler by running `wrangler types tests/workers/worker-configuration.d.ts --config tests/workers/wrangler.toml` (hash: 833bcdb270387818199ab3bcc7460e75)
// Runtime types generated with workerd@1.20260317.1 2024-09-25 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "Counter" | "Aggregator";
	}
	interface Env {
