/**
 * Workers integration tests for plain-counter example.
...
const SECRET = "test-secret-for-plain-counter";
...
describe("plain-counter: counter operations", () => {
  ...
  it("RESET requires service caller", async () => {
    ...
    // Client reset — should be rejected (403)
  ...
  it("tracks per-caller access counts", async () => {
    ...
    // user-1 initializes and increments twice
    ...
    // user-1 sees their access count
    ...
    // user-2 sees their access count
