/**
 * Hono + Actor Kit example: Counter using Redux adapter.
 *
 * Demonstrates:
 * - fromRedux adapter for Redux-based actor logic
...
app.get("/", (c) =>
  c.json({
    name: "hono-redux-counter",
    description: "Counter using Redux adapter",
    routes: [
      "POST /token",
