/**
 * Workers integration tests for xstate-store-counter example.
...
const SECRET = "test-secret-for-xstate-store-counter";
...
describe("xstate-store-counter: routes", () => {
...
describe("xstate-store-counter: auth", () => {
...
describe("xstate-store-counter: counter operations", () => {
